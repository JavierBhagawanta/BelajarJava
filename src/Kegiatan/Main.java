...
public class Main {
    ...
    public static void main(String[] args) {
        books.add(new Book("14022005", "The Begins", "Jhon", "", 3));
        books.add(new Book("20050214", "The Dark Knight", "Alex", "Tech", 2));
        books.add(new Book("02142005", "The Dark Knight Rises", "Madam", "Tech", 1));
